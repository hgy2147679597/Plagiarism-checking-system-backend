...
public class AESSecretUtils {
    ...
    public static void main(String[] args) {
        String ss = encryptToStr("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOiIxMjMiLCJ1c2VyTmFtZSI6Ikp1ZHkiLCJleHAiOjE1MzI3Nzk2MjIsIm5iZiI6MTUzMjc3NzgyMn0.sIw_leDZwG0pJ8ty85Iecd_VXjObYutILNEwPUyeVSo", "1a2b3c4d5e6f7g8h");
        System.out.println(ss);
        System.out.println(decryptToStr(ss, "1a2b3c4d5e6f7g8h"));
    }
